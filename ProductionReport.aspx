<%@ Page Title="Production Report" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Task">
                                <ItemTemplate>
                                    ...
                                    <asp:HiddenField ID="hdn_Task" runat="server" Value='<%# Eval("Task")%>'></asp:HiddenField>
                                </ItemTemplate>
                            </asp:TemplateField>
