<%@ Page Title="Job Card Report" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="JobCardReport.aspx.cs" Inherits="JobCardReport" %>

<%--Ajax Control toolkit Assembly to Support Calendar Extendar--%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <style>
    	<%--Inline CSS To Bootstrap Datatable--%>
        .datatable tbody {
		...
		<%--Opacity Set To Transparent If Change Password Is Clicked--%>
        .modal-backdrop.in {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
       ...
       <%-- Main Content--%>
        <div class="card-body">
            ...
            <div class="left-inner-addon">
                <label for="lbl_EmployeeID" runat="server" class="label-title">
                    Employee</label>
            ...
            <div class="form-group">
            <div class="left-inner-addon">
                <label id="lbl_ProjectID" runat="server" class="label-title">
                    Project</label>
                    <i class="fa fa-folder-open"></i>
                <asp:DropDownList ID="ddl_Project" CausesValidation="true" class="form-control" runat="server"
                    AutoPostBack="true" OnSelectedIndexChanged="ddl_Project_SelectedIndexChanged">
                    <asp:ListItem></asp:ListItem>
                </asp:DropDownList>
                    ...
                    <asp:GridView ID="grd_DPR" runat="server" CssClass="dataTables_wrapper dt-foundation display datatable"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Break">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_Break" runat="server" Text='<%# Eval("Break") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
    ...
    <%-- External JS Files To Support Jquery,Bootstrap,Bootstrap Datatable --%>
